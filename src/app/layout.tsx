...
export const metadata: Metadata = {
  title: "MVPBlocks | Build Your MVPs Efficiently",
  description: "Create exceptional MVPs with MVPBlocks. Discover features, pricing, and more.",
  keywords: "MVP, SaaS, startup tool, MVPBlocks",
  metadataBase: new URL("https://example.com"),
  alternates: { canonical: "https://example.com" },
  openGraph: {
    title: "MVPBlocks | Build Your MVPs Efficiently",
    description: "Create exceptional MVPs with MVPBlocks.",
